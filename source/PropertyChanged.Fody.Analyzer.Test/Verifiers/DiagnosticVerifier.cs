...
namespace PropertyChanged.Fody.Analyzer.Test
{
    ...
    public abstract partial class DiagnosticVerifier
    {
        ...
        public static DiagnosticResultLocation[] AnyLocation { get; } = new[] { new DiagnosticResultLocation(string.Empty, 1, 1) };

        public static string AnyMessage { get; } = "any message at all this is impossible to match by mistake 123125152353";
        ...
        private static void VerifyDiagnosticResults(IEnumerable<Diagnostic> actualResults, DiagnosticAnalyzer analyzer, params DiagnosticResult[] expectedResults)
        {
            ...
            for (int i = 0; i < expectedResults.Length; i++)
            {
                ...
                if (!ReferenceEquals(expected.Locations, AnyLocation))
                {
                ...
                if (expected.Message != AnyMessage && actual.GetMessage() != expected.Message)
                {
                    Assert.IsTrue(false,

...
namespace PropertyChanged.Fody.Analyzer.Test
{
    ...
    public abstract partial class DiagnosticVerifier
    {
        ...
        private static readonly MetadataReference PropertyChangedReference =
            ...
            Document[] documents)
        {
            ...
            foreach (var project in projects)
            {
                ...
                var compilationDiags = compilationWithAnalyzers.GetAllDiagnosticsAsync().Result;
                var diags = compilationWithAnalyzers.GetAnalyzerDiagnosticsAsync().Result;
                var errors = compilationDiags.Where(x =>
                    x.Severity >= DiagnosticSeverity.Error && !diags.Contains(x) && x.Id != "CS0246" /* missing dependency */);
                if (errors.Any())
                {
        ...
        private static Project CreateProject(string[] sources, string language = LanguageNames.CSharp)
        {
            ...
            var systemRuntimeRef = MetadataReference.CreateFromFile(systemRuntimeAssembly.Location);
            ...
            var solution = new AdhocWorkspace()
                ...
                .AddMetadataReference(projectId, PropertyChangedReference)
                .AddMetadataReference(projectId, systemRuntimeRef);
